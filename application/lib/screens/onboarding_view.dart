...
class Onboarding extends StatelessWidget {
  const Onboarding(
      {super.key, required this.title, required this.description, this.onNext});
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        bottomNavigationBar: Padding(
          ...
          child: SizedBox(
              width: 348, height: 48, child: NextButton(onNext: onNext)),
        ),
      ),
    );
  }
...
class NextButton extends StatelessWidget {
  const NextButton({super.key, this.onNext});
